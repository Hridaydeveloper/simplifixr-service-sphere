      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#services" className="text-gray-700 hover:text-[#00F5D4] transition-colors">Explore services</a>
            <a href="#about" className="text-gray-700 hover:text-[#00F5D4] transition-colors">Why simplifixr?</a>
            <a href="#provider" className="text-gray-700 hover:text-[#00F5D4] transition-colors">Earn with us</a>
            <a href="#contact" className="text-gray-700 hover:text-[#00F5D4] transition-colors">Help & Support</a>
          </div>
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-gray-700 hover:text-[#00F5D4]">
