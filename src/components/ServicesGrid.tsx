...
const ServicesGrid = () => {
  ...
  return <section id="services" className="py-20 my-0 mx-0 px-0 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <button onClick={handleServiceClick} className="text-[#00D4AA] font-semibold hover:text-[#00C49A] transition-colors">
            View All Services →
          </button>
        </div>
      </div>
